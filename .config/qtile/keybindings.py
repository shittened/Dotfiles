...
keys = [
    ...
    Key([mod], "r", lazy.spawn("dmenu_run -nb " + color2 + " -nf " + color3 + " -sf " + color2 + " -sb " + color1 + " -i -l 15 -fn 'Sauce Code Nerd Font Bold 12' -p 'Apps: ' -x 20 -y 65 -z 600 -bw 4"), desc="Launch apps"),
    ...
    Key([], "XF86AudioRaiseVolume", lazy.spawn("pactl set-sink-volume 0 +5%"), desc='Volume +5%'),
    #Key([], "XF86AudioLowerVolume", lazy.spawn("amixer -q sset Master 5%-"), desc='Volume -5%'),
    Key([], "XF86AudioLowerVolume", lazy.spawn("pactl set-sink-volume 0 -5%"), desc='Volume -5%'),
    Key([], "XF86AudioMute", lazy.spawn("amixer -q sset Master toggle"), desc='Toggle mute'),
    Key([], "XF86MonBrightnessDown", lazy.spawn("xbacklight - 10"), desc='Brightness -10%'),
    Key([], "XF86MonBrightnessUp", lazy.spawn("xbacklight + 10"), desc='Brightness +10%'),
